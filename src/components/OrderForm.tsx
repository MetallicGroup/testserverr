...
import { Upload, X, CheckCircle2, Package, Paintbrush, User, Send } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-10 md:py-16">
        <div className="mb-10 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Comandă Produse Personalizate</h1>
          <p className="mt-2 text-muted-foreground">Completează formularul pentru a primi o ofertă personalizată.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <section className="space-y-4">
            ...
            {/* Product grid */}
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-60 overflow-y-auto rounded-lg border border-border p-2">
